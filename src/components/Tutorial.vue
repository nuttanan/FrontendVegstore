<template>
  <div v-if="currentTutorial" class="edit-form py-3">
    ...
    <v-form ref="form" lazy-validation>
      <v-text-field
        v-model="currentTutorial.title_tutorial"
      ...
      {{ currentTutorial.published_tutorial ? "Published" : "Pending" }}
  ...
  methods: {
    ...
    updatePublished(status) {
      var data = {
        ...
        title: this.currentTutorial.title_tutorial,
        description: this.currentTutorial.description_tutorial,
        published: status,
      };
